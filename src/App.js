  ...
  return (
    <>
      ...
      <div className="max-w-2xl mx-auto py-5">
        <a href="https://github.com/fatihdelice/react-firebase-auth" target="_blank" id="github" aria-label="View source on GitHub"><svg id="github" width="80" height="80" viewBox="0 0 250 250" aria-hidden="true">
